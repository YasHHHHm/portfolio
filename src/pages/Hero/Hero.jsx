...
export default function Hero() {
  const words = [
    "Front End Developer & Project Enthusiast",
...
const profile = {
    name: 'Yash Mehra',
    title: 'Web Developer | UI/UX Enthusiast | Project Geeks',
    skills: [
        'React', 'JavaScript', 'PrismaORM', 'Rest Api',
        ...
        >
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              {/* Welcome badge */}
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 mt-16 lg:mt-0 mb-6 sm:mb-8 animate__animated animate__fadeInDown animate__delay-1s">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  React.JS lover 🚀 | Website FreeLancer 🔧 | Crafting frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/YasHHHHm"
                ...
                {/* Contact Button */}
                <a
  href="https://drive.google.com/file/d/1SblVTTZjuSZ3HqcjKaS4P9kvmgaWInFB/view?usp=sharing"
  target="_blank"
