...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "54ff367a-4627-4c97-b16c-bb15f11a04bc"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">yashmehra0410@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="https://www.linkedin.com/in/yashmehra04"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-400 hover:underline"
                    >
                      linkedin.com/in/yashmehra04
                    </a>
                  </div>
                </div>
              </div>
